...
public class SparseBoundedGrid<Object> extends AbstractGrid<Object>
{
    ...
    public SparseBoundedGrid(int rows, int cols)
    {
	    ...
	    occupantArray.add( new LinkedList() );
	    for (int p = 0; p < cols; p++)
		occupantArray.get(i).add( null );
	}
    }
    ...
    public Object get(Location loc)
    {
        if (!isValid(loc))
            throw new IllegalArgumentException("Location " + loc
                    + " is not valid");
        return (Object) occupantArray.get(loc.getRow()).get(loc.getCol()); // unavoidable warning
    }
    ...
    public Object put(Location loc, Object obj)
    {
        ...
        occupantArray.get(loc.getRow()).get(loc.getCol()) = obj;
        return oldOccupant;
    }
    ...
    public Object remove(Location loc)
    {
        ...
        Object r = get(loc);
        occupantArray.get(loc.getRow()).get(loc.getCol()) = null;
        return r;
    }
}
